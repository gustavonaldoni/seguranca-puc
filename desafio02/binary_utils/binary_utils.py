...
class BinaryUtils:
    """
    Contains several methods for working with binary files, including
    the correct way to copy and write directly on them.
    """

    def _generate_default_file_path(self, file_path: str) -> str:
        """
        Generates a default file path based on the path passed as argument.
        Example: '/usr/bin/file.pdf' -> '/usr/bin/file_safecopy.pdf'
        """
